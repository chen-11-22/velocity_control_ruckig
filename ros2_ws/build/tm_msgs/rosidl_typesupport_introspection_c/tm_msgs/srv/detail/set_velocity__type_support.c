...
#include <stddef.h>
#include "tm_msgs/srv/detail/set_velocity__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tm_msgs__srv__SetVelocity_Request__init(message_memory);
}

void SetVelocity_Request__rosidl_typesupport_introspection_c__SetVelocity_Request_fini_function(void * message_memory)
{
  tm_msgs__srv__SetVelocity_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetVelocity_Request__rosidl_typesupport_introspection_c__SetVelocity_Request_message_member_array[2] = {
  {
    "motion_type",  // name
    ...
    offsetof(tm_msgs__srv__SetVelocity_Request, motion_type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tm_msgs__srv__SetVelocity_Request, velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetVelocity_Request__rosidl_typesupport_introspection_c__SetVelocity_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(tm_msgs__srv__SetVelocity_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, SetVelocity_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember SetVelocity_Response__rosidl_typesupport_introspection_c__SetVelocity_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tm_msgs__srv__SetVelocity_Response, ok),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetVelocity_Response__rosidl_typesupport_introspection_c__SetVelocity_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tm_msgs__srv__SetVelocity_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_tm_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, SetVelocity_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_members = {
  "tm_msgs__srv",  // service namespace
  "SetVelocity",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_Request_message_type_support_handle,
  NULL  // response message
  // tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_Response_message_type_support_handle
};

static rosidl_service_type_support_t tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_type_support_handle = {
  0,
  &tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, SetVelocity)() {
  if (!tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_type_support_handle.typesupport_identifier) {
    tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, SetVelocity_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, SetVelocity_Response)()->data;
  }

  return &tm_msgs__srv__detail__set_velocity__rosidl_typesupport_introspection_c__SetVelocity_service_type_support_handle;
}
